...
token_str = paste0("Bearer ",readLines("ouraring.txt"))

r <- GET(
  url = "https://api.ouraring.com/v2/usercollection/daily_sleep"
  , query = list(start_date = "2024-01-01", end_date = "2024-01-08")
  , add_headers(.headers = c("Authorization" = token_str))
    )
content(r)

r = GET(url = "https://api.ouraring.com/v2/usercollection/sleep"
    , query = list(start_date = "2024-01-01", end_date = "2024-01-08")
    ,add_headers("Authorization" = token_str)
    )
content(r)
